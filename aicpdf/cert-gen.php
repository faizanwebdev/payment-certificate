...
//        $id = 123;
        ...
        if($membershipname == "Regular Membership"){
            $memberslug = "RGM";
            $membershipno = date('Ym').$ftwo.$ltwo.$memberslug.date('d');
              ...
              require_once 'mailer/PHPMailerAutoload.php';
                    ...
                    $mail->Password = 'Securityenlyft@2022#$%';    
                    $mail->SMTPSecure = 'tls';   
                    $mail->Port = 587;
    ...
    //                $mail->addBCC('faizan.kazi@enlyft.in', 'User'); 
             ...
             echo "<div class='container'><a href='$outputpdf' class='btn btn-success'>Download Certificate</a><br></div>";
            ...
            if($membershipname == "Life Membership"){
            $memberslug = "LFM";
            }
            if($membershipname == "Corporate Membership"){
                $memberslug = "CPM";
            }
            if($membershipname == "Patron Membership"){
                $memberslug = "PTM";
            }
            $membershipno = date('Ym').$ftwo.$ltwo.$memberslug.date('d');
...
<script>
setTimeout(function(){
   window.location.href = 'https://5ku.d9e.myftpupload.com/';
}, 25000);
</script>
